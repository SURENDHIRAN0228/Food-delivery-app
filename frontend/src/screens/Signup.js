...
export default function Signup() {
  ...
  const handleClick = async (e) => {
    ...
    const response = await fetch("https://food-delivery-app-api-flame.vercel.app/api/auth/getlocation", {
      method: 'POST',
      headers: {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const response = await fetch("https://food-delivery-app-api-flame.vercel.app/api/auth/createuser", {
      // credentials: 'include',
